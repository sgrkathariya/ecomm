...
// cateogry-Card routes
Route::get('category-cards', 'CategoryCardController@index')->name('category-card.index');
Route::post('category-cards', 'CategoryCardController@store')->name('category-card.store');
Route::put('category-cards/sort', 'CategoryCardController@sort')->name('category-card.sort');
Route::delete('category-cards/remove-item', 'CategoryCardController@removeItem')->name('category-card.remove-item');

//Social-media
Route::get('social-medias','SocialMediaController@index')->name('social-medias.index');
Route::post('social-medias','SocialMediaController@store')->name('social-medias.store');
Route::put('social-medias/{socialMedia}','SocialMediaController@update')->name('social-medias.update');
Route::get('social-medias/{socialMedia}/edit',[SocialMediaController::class,'edit'])->name('social-medias.edit');
Route::delete('social-medias/{socialMedia}','SocialMediaController@destroy')->name('social-medias.destroy');
