...
<a href="{{ route('home') }}" class="brand-link text-center" target="_blank">
    <img src="{{ siteLogoUrl() }}" alt="{{ config('app.name') }}" class="" style="opacity: .8; height: 2rem;">
...
<div class="sidebar">
    ...
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-flat" data-widget="treeview"
            ...
            <li class="nav-item">
                <a href="{{ route('backend.orders.index') }}" class="nav-link {{ setActive('backend.orders.*') }}">
                    <span class="nav-icon svg-icon svg-baseline">
                    ...
                    <p>
                        Orders
                        <livewire:incomplete-orders-count>
                    </p>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{ route('products.index') }}" class="nav-link {{ setActive('products.*') }}">
                    <span class="nav-icon svg-icon svg-baseline">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-box"
                            viewBox="0 0 16 16">
                            <path
            ...
            @hasanyrole('super-admin|admin')
                <li class="nav-item">
                    <a href="{{ route('categories.index') }}" class="nav-link {{ setActive('categories.*') }}">
                        <span class="nav-icon svg-icon svg-baseline">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-grid"
                                viewBox="0 0 16 16">
                                <path
            ...
            @hasanyrole('super-admin|admin')
                <li class="nav-item">
                    <a href="{{ route('brands.index') }}" class="nav-link {{ setActive('brands.*') }}">
                        <span class="nav-icon svg-icon svg-baseline">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            @hasanyrole('super-admin|admin')
                <li class="nav-item">
                    <a href="{{ route('category-menu.index') }}" class="nav-link {{ setActive('category-menu.*') }}">
                        <span class="nav-icon svg-icon svg-baseline">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            @hasanyrole('super-admin|admin')
                <li class="nav-item">
                    <a href="{{ route('category-card.index') }}" class="nav-link {{ setActive('category-card.*') }}">
                        <span class="nav-icon svg-icon svg-baseline">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            @hasanyrole('super-admin|admin')
                <li class="nav-item">
                    <a href="{{ route('coupons.index') }}" class="nav-link {{ setActive('coupons.*') }}">
                        <span class="nav-icon svg-icon svg-baseline">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                ...
                <li class="nav-item">
                    <a href="{{ route('contact-form-submissions.index') }}"
                        class="nav-link {{ setActive('contact-form-submissions.*') }}">
                        <span class="nav-icon svg-icon svg-baseline">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            {{-- @hasanyrole('super-admin|admin')
            <li class="nav-item">
                <a href="{{ route('stores.index') }}" class="nav-link {{ setActive('stores.*') }}">
                    <span class="nav-icon svg-icon svg-baseline">
            ...
            @hasanyrole('super-admin|admin')
                <li class="nav-item">
                    <a href="{{ route('image-sliders.index') }}" class="nav-link {{ setActive('image-sliders.*') }}">
                        <span class="nav-icon svg-icon svg-baseline">
            ...
            @hasanyrole('super-admin|admin')
                <li class="nav-item">
                    <a href="{{ route('social-medias.index') }}" class="nav-link {{ setActive('social-medias.*') }}">
                        <span class="nav-icon svg-icon svg-baseline">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            @endhasanyrole
            @hasanyrole('super-admin|admin')
                <li class="nav-item has-treeview @if (Request::routeIs('settings.*')) menu-open @endif">
                    <a href="#" class="nav-link {{ setActive('settings.*') }}">
                        <span class="nav-icon svg-icon svg-baseline">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('settings.general.index') }}"
                                class="nav-link {{ setActive('settings.general.index') }}">
                                <i class="far fa-circle nav-icon text-indigo"></i>
                                <p>General</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('settings.api-and-keys.index') }}"
                                class="nav-link {{ setActive('settings.api-and-keys.index') }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('settings.email.index') }}"
                                class="nav-link {{ setActive('settings.email.index') }}">
                                <i class="far fa-circle nav-icon text-success"></i>
                                <p>Email Settings</p>
                            </a>
                        </li>
                        {{-- <li class="nav-item">
                            <a href="{{ route('settings.payment.index') }}"
                                class="nav-link {{ setActive('settings.payment.index') }}">
                                <i class="far fa-circle nav-icon text-warning"></i>
                                <p>Payment Settings</p>
                            </a>
                        </li> --}}
                        <li class="nav-item">
                            <a href="{{ route('settings.image-sliders.index') }}"
                                class="nav-link {{ setActive('settings.image-sliders.index') }}">
                                <i class="far fa-circle nav-icon text-indigo"></i>
                                <p>Image Slider</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('settings.footer.index') }}"
                                class="nav-link {{ setActive('settings.footer.index') }}">
            ...
            @hasrole('super-admin')
                <li class="nav-item">
                    <a href="{{ route('system.logs') }}" class="nav-link" target="_blank">
                        <span class="nav-icon svg-icon svg-baseline">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-bug"
                                viewBox="0 0 16 16">
                                <path
            ...
            {{-- <li class="nav-item">
                <a href="{{ route('category-menu.index') }}" class="nav-link">
            <i class="nav-icon far fa-circle text-danger"></i>
            <p>Catalog Menu</p>
            </a>
            </li> --}}
            {{-- <li class="nav-item">
                <a href="{{ route('product-grids.index') }}" class="nav-link {{ setActive('product-grids.index') }}">
                    <span class="nav-icon svg-icon svg-baseline">
            ...
            @hasanyrole('super-admin|admin')
                {{-- <li class="nav-item">
                <a href="{{ route('product-group.index') }}" class="nav-link {{ setActive('product-group.index') }}">
                    <span class="nav-icon svg-icon svg-baseline">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-columns" viewBox="0 0 16 16">
                            <path d="M0 2a1 1 0 0 1 1-1h14a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1V2zm8.5 0v8H15V2H8.5zm0 9v3H15v-3H8.5zm-1-9H1v3h6.5V2zM1 14h6.5V6H1v8z" />
                        </svg>
                ...
                <li class="nav-item">
                    <a href="{{ route('pages.index') }}" class="nav-link {{ setActive('pages.*') }}">
                        <span class="nav-icon svg-icon svg-baseline">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-journal-check"
                                viewBox="0 0 16 16">
                                <path fill-rule="evenodd"
