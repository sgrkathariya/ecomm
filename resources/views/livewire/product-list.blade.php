        ...
        <x-box class="mb-4">
            <form wire:submit.prevent="search" class="form-inline">
                <div class="form-row align-items-center">
                    ...
                    <div class="col-auto form-group ">
                        <select wire:model.defer="filter.brand_id" class="custom-select">
            ...
            <table class="table table-responsive-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="white-space: nowrap;">{{ priceUnit() }} {{ number_format($product->current_price) }}</div>
                            @if ($product->hasDiscount())
                            <div style="text-decoration: line-through; font-size: .9rem; white-space: nowrap;">
                                {{ priceUnit() }} {{ number_format($product->regular_price) }}
                            </div>
                            @endif
                        </td>
                        <td><span class="badge badge-light">{{ $product->category->name }}</span></td>
                        <td><span class="badge badge-light">{{ $product->brand->name }}</span></td>
