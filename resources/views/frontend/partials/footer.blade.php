            ...
            <div class="w-full md:w-3/12 px-3">
                <div class="content">
                    ...
                    @if (settings()->get('about_us_page_slug') != null)
                        <div class="pt-3">
                            <a class="text-white py-2 px-2 md:px-4 my-3 bg-primary hover:bg-indigo-700 hover:shadow-lg focus:shadow-outline text-xs rounded-full"
                                href="{{ route('frontend.pages.show', settings()->get('about_us_page_slug')) }}">Read
                                More</a>
                        </div>
                    @endif
                </div>
                ...
                <div class="content">
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a class="hover:text-primary"
                                href="{{ route('frontend.pages.show', 'about-us') }}">About-Us</a></li>
                        <li><a class="hover:text-primary" href="{{ route('frontend.blogs.index') }}">Blogs</a></li>
                        <li><a class="hover:text-primary" href="{{ route('frontend.contact-form.index') }}">Contact</a>
                        </li>
                        <li><a class="hover:text-primary"
                                href="{{ route('frontend.pages.show', 'privacy-policy') }}">Privacy Policy</a></li>
                        <li><a class="hover:text-primary"
                                href="{{ route('frontend.pages.show', 'terms-and-Conditions') }}">Terms & conditions</a>
                        </li>
                    </ul>
                    </p>
                </div>
                ...
                <div class="content">
                    ...
                    <ul>
                        <li>
                            ...
                            <address>{{ settings('address', 'Dhangadhi, Kailali Nepal') }}</address>
                        </li>
                        <li>
                            <div class="opacity-75">E-mail:</div>
                            <a
                                href="mailto:{{ settings('topbar_email', 'info@makaludogchew.com') }}">{{ settings('topbar_email', 'info@makaludogchew.com') }}</a>
                        </li>
                        <li>
                            <div class="opacity-75">Phone:</div>
                            <a
                                href="tel:{{ settings('topbar_mobile', '123456789') }}">{{ settings('topbar_mobile', '123456789') }}</a>
                        </li>
                    </ul>
                    </p>
                </div>
...
@mobile
    ...
    <aside id="sidebar-category"
        class="md:hidden fixed top-0 left-0 h-screen bg-white shadow-lg transition-all duration-500 z-20"
        style="width: 280px; margin-left: -280px">
