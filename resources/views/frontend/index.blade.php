...
@section('content')
    <div style="background-color: #f5f5f5;">
        ...
        <div class="container py-">
            <section class="mb-4">
                <div class="flex items-center mb-4 sm:mb-6">
                    ...
                    <a class="ml-auto text-sm text-red-600 font-semibold hover:underline"
                        href="{{ route('frontend.products.by-group', 'top') }}">View All</a>
                </div>
        ...
        <div class="container py-5">
            <section class="mb-4">
                <div class="flex items-center mb-4 sm:mb-6">
                    <h2 class="tracking-wide text-lg">Categories</h2>
                </div>
                <x-category-card-view/>
            </section>
        </div>
        ...
        <div class="container py-5">
            <section class="mb-4">
                <div class="flex items-center mb-4 sm:mb-6">
                    ...
                    <a class="ml-auto text-sm text-red-600 font-semibold hover:underline"
                        href="{{ route('frontend.products.index') }}">View All</a>
                </div>
        ...
        <div class="container py-5">
            <section class="mb-4">
                <div class="flex items-center mb-4 sm:mb-6">
                    ...
                    <a class="ml-auto text-sm text-red-600 font-semibold hover:underline"
                        href="{{ route('frontend.products.by-group', 'brand') }}">View All</a>
                </div>
                <x-brand-card />
            </section>
        </div>
            ...
            <div class="container py-5 md:py-8 ">
                    ...
                    @foreach ($posts as $post)
                        <div class="bg-white rounded shadow-sm overflow-hidden">
                            ...
                            <div class="p-4">
                                ...
                                <a href="{{ route('frontend.blogs.show', $post) }}"
                                    class="underline text-sm font-semibold mt-4">Read More</a>
                            </div>
                        </div>
                    @endforeach
                </div>
                <div class="text-center mt-5 sm:mt-6">
                    <a href="{{ route('frontend.blogs.index') }}"
                        class="inline-block py-2 px-4 bg-blue-600 text-white rounded-full hover:bg-blue-500 font-semibold text-sm">View
                        All Blogs</a>
                </div>
            </div>
        </div> --}}
