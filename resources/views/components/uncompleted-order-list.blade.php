        ...
        <div class="d-flex align-items-center">
            ...
            <div class="ml-auto">
                <div class="card-tools">
                    <button type="button" class="btn btn-tool z-depth-0" data-card-widget="collapse"><i
                    ...
                    <tr>
                        <td>
                            <a class="text-primary font-semibold"
                                href="{{ route('backend.orders.show', $order) }}">#{{ $order->id }}</a>
                        </td>
                        <td>
                            <div class="d-flex align-items-center">
                                <img class="img-circle" src="{{ $order->user->gravatar }}"
                        ...
                        <td>
                            <span
                                class="payment-status-badge {{ $order->payment_status }}">{{ ucfirst($order->payment_status) }}</span>
                        </td>
                        <td>{{ $order->created_at->isoFormat('lll') }}</td>
                        <td class="text-right">
                            <a type="button" class="text-primary" data-toggle="dropdown" aria-haspopup="true"
                                aria-expanded="false">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item"
                                    href="{{ route('backend.orders.show', $order) }}?update=true"><span
                                        class="mr-2"><i class="far fa-edit"></i></span>Update Order</a>
                            </div>
                        </td>
                    </tr>
                @empty
