<div class="bg-white grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-6 gap-2">
    @foreach ($categoryCards as $categoryCard)
        @foreach ($categories as $category)
            @if ($categoryCard->category_id == $category->id)
                <div class="product__card m-1 flex flex-col bg-white shadow-sm hover:shadow">
                    <div class="relative">
