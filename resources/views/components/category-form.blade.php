    ...
    <div class="card-body">
        ...
        <form action="{{ $category->exists ? route('categories.update', $category) : route('categories.store') }}"
            ...
            <x-form.form-group for="thumbnail">
                <label for="thumbnail">Category Logo</label>
                <div class="custom-file">
                    <input type="file" name="thumbnail" class="custom-file-input" id="category-logo-input"
                        aria-describedby="category-logo-prepend" accept="image/*">
                    <label class="custom-file-label" for="category-logo-input">Choose file</label>
                </div>
            </x-form.form-group>
            ...
            <div class="form-group">
                <button type="submit"
                    class="btn btn-primary z-depth-0 text-capitalize">{{ $category->exists ? 'Update Category' : 'Add new category' }}</button>
            </div>
